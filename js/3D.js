...
function THREED(ObjRepre,main,ObjP)
{
    ...
    {
    var tubepath = [{"point" :new THREE.Vector3(atom1.X,atom1.Y,atom1.Z)},{"point" :new THREE.Vector3(atom2.X,atom2.Y,atom2.Z)}];
                var actualpoints =[];
   ...
   // ObjectsSkeleton.push(innertubeMesh);
    ...
    this.CenterObjects=function(x,y,z)
    {
        ...
        for(var i in ObjThis.molecule.GetAtoms())
        {
            ...
            atom.CPK.position=atom.Draw.position;
        }
